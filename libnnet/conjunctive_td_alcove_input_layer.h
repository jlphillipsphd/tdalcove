...
// 
//
#ifndef CONJUNCTIVE_TD_ALCOVE_INPUT_LAYER_H
#define CONJUNCTIVE_TD_ALCOVE_INPUT_LAYER_H
...
class ConjunctiveTD_ALCOVEInputLayer : public ALCOVEInputLayer {

public:
	ConjunctiveTD_ALCOVEInputLayer();
	~ConjunctiveTD_ALCOVEInputLayer();
	ConjunctiveTD_ALCOVEInputLayer(int number_of_units, double td_learning_rate);
	ConjunctiveTD_ALCOVEInputLayer(int number_of_units,
