...
// 
//
#ifndef INTEGRAL_ALCOVE_OBJECTIVE_MODEL_H
#define INTEGRAL_ALCOVE_OBJECTIVE_MODEL_H
...
class IntegralALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	IntegralALCOVE_ObjectiveModel();
	IntegralALCOVE_ObjectiveModel(int problem_number);
	IntegralALCOVE_ObjectiveModel(int problem_number, list<unsigned int> &seed_list);
