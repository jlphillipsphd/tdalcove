...
// 
//
#ifndef CONTINUOUS_ALCOVE_OBJECTIVE_MODEL_H
#define CONTINUOUS_ALCOVE_OBJECTIVE_MODEL_H
...
class ContinuousALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	ContinuousALCOVE_ObjectiveModel();
	ContinuousALCOVE_ObjectiveModel(int problem_number);
	ContinuousALCOVE_ObjectiveModel(int problem_number, list<unsigned int> &seed_list);
