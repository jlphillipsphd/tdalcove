...
// 
//
#ifndef CONTINUOUS_CONJUNCTIVE_TD_ALCOVE_OBJECTIVE_MODEL_H
#define CONTINUOUS_CONJUNCTIVE_TD_ALCOVE_OBJECTIVE_MODEL_H
...
class ContinuousConjunctiveTD_ALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	ContinuousConjunctiveTD_ALCOVE_ObjectiveModel();
	ContinuousConjunctiveTD_ALCOVE_ObjectiveModel(int problem_number);
	ContinuousConjunctiveTD_ALCOVE_ObjectiveModel(int problem_number, list<unsigned int> &seed_list);
