...
#ifndef CUBIC_COARSE_CODE_LAYER_H
#define CUBIC_COARSE_CODE_LAYER_H

class CubicCoarseCodeLayer : public CoarseCodeLayer {

public:
	CubicCoarseCodeLayer();
	...
	CubicCoarseCodeLayer(CubicActivationFunction* caf,
