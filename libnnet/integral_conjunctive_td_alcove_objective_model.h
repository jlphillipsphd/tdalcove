...
// 
//
#ifndef INTEGRAL_CONJUNCTIVE_TD_ALCOVE_OBJECTIVE_MODEL_H
#define INTEGRAL_CONJUNCTIVE_TD_ALCOVE_OBJECTIVE_MODEL_H
...
class IntegralConjunctiveTD_ALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	IntegralConjunctiveTD_ALCOVE_ObjectiveModel();
	IntegralConjunctiveTD_ALCOVE_ObjectiveModel(int problem_number);
	IntegralConjunctiveTD_ALCOVE_ObjectiveModel(int problem_number, list<unsigned int> &seed_list);
