...
// 
//
#ifndef CMACS_TD_HIDDEN_ALCOVE_INPUT_LAYER_H
#define CMACS_TD_HIDDEN_ALCOVE_INPUT_LAYER_H
...
class CMACS_TD_HiddenALCOVEInputLayer : public ALCOVEInputLayer, CMACS_CoarseCodeLayerSet {

public:
	CMACS_TD_HiddenALCOVEInputLayer();
	~CMACS_TD_HiddenALCOVEInputLayer();
	CMACS_TD_HiddenALCOVEInputLayer(int number_of_units, double td_learning_rate);
	CMACS_TD_HiddenALCOVEInputLayer(int number_of_units,
