...
// 
//
#ifndef SIX_TYPE_CMACS_TD_ALCOVE_OBJECTIVE_MODEL_H
#define SIX_TYPE_CMACS_TD_ALCOVE_OBJECTIVE_MODEL_H
...
class SixTypeCMACS_TD_ALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	SixTypeCMACS_TD_ALCOVE_ObjectiveModel();
	SixTypeCMACS_TD_ALCOVE_ObjectiveModel(list<unsigned int> &seed_list);
