...
// 
//
#include "cmacs_td_coarse_code_layer_set.h"

CMACS_TD_CoarseCodeLayerSet::CMACS_TD_CoarseCodeLayerSet() : Object() {
	layers = NULL;
}

CMACS_TD_CoarseCodeLayerSet::~CMACS_TD_CoarseCodeLayerSet() {
...
CMACS_TD_CoarseCodeLayerSet::CMACS_TD_CoarseCodeLayerSet(int dimensionality,
	...
	layers = new TDCubicCoarseCodeLayer*[tiles];
	for (x = 0; x < tiles; x++) {
		layers[x] = new TDCubicCoarseCodeLayer(caf, side_units, code_mins, code_maxes, af, discount_rate);
		the_one[x] = 0;
		temp[x] = 0;
...
bool CMACS_TD_CoarseCodeLayerSet::getCoarseActs(double* pos) {
...
bool CMACS_TD_CoarseCodeLayerSet::setCoarseActs(double* pos) {
...
int CMACS_TD_CoarseCodeLayerSet::getNumberOfTilings() {
	if (layers == NULL)
		return -1;
...
TDCubicCoarseCodeLayer* CMACS_TD_CoarseCodeLayerSet::getTiling(int val) {
...
bool CMACS_TD_CoarseCodeLayerSet::getWinningUnitIndexes(int* the_ones) {
