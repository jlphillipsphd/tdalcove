...
// 
//
#ifndef CONJUNCTIVE_TD_INTEGRATED_ALCOVE_INPUT_LAYER_H
#define CONJUNCTIVE_TD_INTEGRATED_ALCOVE_INPUT_LAYER_H
...
class ConjunctiveTD_IntegratedALCOVEInputLayer : public ALCOVEInputLayer {

public:
	ConjunctiveTD_IntegratedALCOVEInputLayer();
	~ConjunctiveTD_IntegratedALCOVEInputLayer();
	ConjunctiveTD_IntegratedALCOVEInputLayer(int number_of_units, double td_learning_rate);
	ConjunctiveTD_IntegratedALCOVEInputLayer(int number_of_units,
