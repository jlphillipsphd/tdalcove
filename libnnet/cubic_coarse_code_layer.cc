...
CubicCoarseCodeLayer::CubicCoarseCodeLayer() : CoarseCodeLayer() {
	return;
}

CubicCoarseCodeLayer::CubicCoarseCodeLayer(CubicActivationFunction* caf,
					int* number_of_units_per_dimension,
					double* minimums_per_dimension,
					double* maximums_per_dimension,
					ActivationFunction* af) :
	CoarseCodeLayer(caf, number_of_units_per_dimension, minimums_per_dimension,
			maximums_per_dimension, af) {
...
bool CubicCoarseCodeLayer::setCoarseActs(double* position) {
	bool return_value = ((CoarseCodeLayer*) this)->setCoarseActs(position);
