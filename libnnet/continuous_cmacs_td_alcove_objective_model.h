...
// 
//
#ifndef CONTINUOUS_CMACS_TD_ALCOVE_OBJECTIVE_MODEL_H
#define CONTINUOUS_CMACS_TD_ALCOVE_OBJECTIVE_MODEL_H
...
class ContinuousCMACS_TD_ALCOVE_ObjectiveModel : public ObjectiveModel {

public:
	ContinuousCMACS_TD_ALCOVE_ObjectiveModel();
	ContinuousCMACS_TD_ALCOVE_ObjectiveModel(int problem_number);
	ContinuousCMACS_TD_ALCOVE_ObjectiveModel(int problem_number, list<unsigned int> &seed_list);
